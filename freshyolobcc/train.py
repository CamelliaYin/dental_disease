...
if __name__ == "__main__":
    opt = parse_opt()
    data_name = 'full_cs'
    opt.data = f'data/{data_name}.yaml'
    algo = 'orig_yolo'
    batch_size = None
    epochs = 300
    opt.name = f'exp_a={algo}_d={data_name}_b={batch_size or "d"}_e={epochs or "d"}'
    opt.exist_ok = True
    if batch_size is not None:
        opt.batch_size = batch_size # Change this to number of train images
