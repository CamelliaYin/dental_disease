...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    x_train = dataset.img_npy
    pred0 = init_nn_output(x_train, bcc_params)
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        # YOLOBCC
        qtargets, pcm['variational'], lb = VBi_yolo(cstargets, pred, pcm['variational'], pcm['prior'])
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            # YOLOBCC
            batch_qtargets = qtargets[i]
